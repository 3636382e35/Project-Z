/*
	...
	// TODO: use this to limit the number of same objects within the room
...
if (creator == noone || (creator == other && creator.id == other.id) || ds_list_find_index(hit_objects, other) != -1) exit;
	...
	if hitbox_id == "judgement_cut"{
		...
		//judgement_cut_hit.image_angle = other.image_xscale < 0 ? 45 : -240;
	...
	//TODO: refactor this behavior (parry state)
...
if instance_exists(o_Player) and creator.object_index == o_Player and other.hp <= 0 {
    ...
    if o_Player.ANNOUNCER_MODE {
					...
					audio_stop_all();
					    //Play audio based on combo count
