...
pos_height = 100 // how tall the history area is (the textbox starts after this) // default 300
...
commands[command_1.spawn]	= "spawn"
...
commands[command_1.restart] = "restart"
...
#region second level commands 
	...
	#region spawn
		...
		do {
			if (object_exists(i)) {
				second_level[command_1.spawn,i] = object_get_name(i)
				second_level[command_1.set,i] = second_level[command_1.spawn,i] // naughty of me to put this here as it breaks the layout but it is less code 
				second_level[command_1.destroy,i] = second_level[command_1.spawn,i] // naughty of me to put this here as it breaks the layout but it is less code 
				second_level[command_1.view,i] = second_level[command_1.spawn,i] // naughty of me to put this here as it breaks the layout but it is less code 
				i++
			} else {
